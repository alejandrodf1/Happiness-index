# Happiness index guide installation
...
To move beyond notebook prototyping, all reusable code should go into the `happiness_index/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `happiness_index` folder and use the modules inside your notebooks :
...
```python
from happiness_index.utils.paths import data_dir
data_dir()
```
